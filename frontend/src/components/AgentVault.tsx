...
export function AgentVault({ 
  ...
  const explorerUrl = isArcMode ? `https://testnet.arcscan.app/address/${agentWallet}` : `https://sepolia.basescan.org/address/${agentWallet}`;
  const explorerTitle = isArcMode ? "View on Arc Explorer" : "View on Basescan";
