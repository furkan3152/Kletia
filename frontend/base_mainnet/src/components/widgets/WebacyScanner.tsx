        ...
        {result && (
          <div className="bg-white dark:bg-[#0F172A] border-[3px] border-[#1A1A1A] dark:border-[#4B5563] shadow-[4px_4px_0_#1A1A1A] dark:shadow-[4px_4px_0_#475569] flex flex-col overflow-hidden">
            <div className={`p-6 border-b-[3px] border-[#1A1A1A] dark:border-[#4B5563] flex flex-col md:flex-row items-center justify-between gap-4 ${
              result.riskScore > 50 ? 'bg-red-500 text-white' : result.riskScore > 20 ? 'bg-yellow-400 text-black' : 'bg-[#00d66f] text-black'
            }`}>
              <div className="flex items-center gap-3">
                {result.riskScore > 50 ? <ShieldAlert className="w-10 h-10" strokeWidth={3} /> : <ShieldCheck className="w-10 h-10" strokeWidth={3} />}
            ...
            <div className="p-6 flex flex-col gap-4">
              ...
              {result.tags && result.tags.length > 0 ? (
                ...
                <div className="text-gray-500 dark:text-gray-400 font-bold italic">Temiz - Herhangi bir risk tespit edilmedi.</div>
              )}
