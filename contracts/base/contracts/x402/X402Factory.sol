...
/// @notice Deploys owner-scoped x402 gateways that settle in a chosen ERC-20.
contract X402Factory {
    ...
    function createGateway(
        ...
        X402Gateway newGateway = new X402Gateway(
            _usdc,
            _initialPrice,
            msg.sender
        );
    ...
    function getOwnerGateways(
        address owner
    ) external view returns (X402Gateway[] memory) {
