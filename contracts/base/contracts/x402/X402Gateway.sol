...
contract X402Gateway is Ownable {
    ...
    constructor(address _usdc, uint256 _initialPrice, address _initialOwner) Ownable(_initialOwner) {
    ...
    function pay(string calldata endpoint) external {
        ...
        require(usdc.transferFrom(msg.sender, address(this), pricePerCall), "Payment failed");
