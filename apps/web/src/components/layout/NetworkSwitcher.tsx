    ...
    <div className="flex items-center" title={error ?? currentNetwork.name}>
      ...
      >
        <div className="flex z-10 w-32 relative">
          ...
          <div
            className={`flex-1 flex items-center justify-center gap-1 px-2 py-1 z-20 text-[10px] font-black uppercase transition-colors ${!isArc ? "text-white" : "text-[#1A1A1A] dark:text-gray-400"}`}
          >
            <span>🔵</span> Base
          </div>
          <div
