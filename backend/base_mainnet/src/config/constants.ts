...
export const ROUTERS = {
    ...
    PANCAKE_SMART_ROUTER: getAddress("0x678Aa4bF4E210cf2166753e054d5b7c31cc7fa86"),
    ...
    COMPOUND_V3_USDC: COMPOUND_V3_BASE.markets.find(({ token }) => token === 'USDC')!.comet,
    COMPOUND_V3_USDBC: COMPOUND_V3_BASE.markets.find(({ token }) => token === 'USDBC')!.comet,
    COMPOUND_V3_WETH: COMPOUND_V3_BASE.markets.find(({ token }) => token === 'WETH')!.comet,
