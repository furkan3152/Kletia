...
} from '../../arc/unifiedBalanceRuntime';
...
export function ArcUnifiedBalanceCard() {
  ...
  const [errorState, setErrorState] = useState<ScopedState<string> | null>(null);
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-sm font-bold leading-relaxed">
            ...
            yalnız Gateway’e yatırılmış, zincirler arası harcanabilir USDC’yi
            ve bekleyen yatırımları gösterir.
          </p>
        </div>
