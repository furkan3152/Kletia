...
const validDecimal = (value: unknown, decimals: number): value is string => {
...
const hasValidPlanShape = (value: unknown): value is ArcAppKitExecutionPlan => {
...
export const isArcAppKitResponseBound = (
  ...
  return (
    ...
    proof.forwardsDestinationMint === (expectedOperation === "bridge")
  );
};
