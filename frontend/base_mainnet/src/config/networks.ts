...
import { ARC_CONTRACTS } from './arcConfig';
        ...
        items: [
          ...
          },
          {
            ...
            action: {
              type: 'prompt',
              prompt:
                '10 USDC ile AERO al, en verimli doğrulanmış rotayı bul',
            },
          },
          {
            id: 'base-stake-well',
...
export const SUPPORTED_CHAINS = [NETWORKS.base.chain, NETWORKS.arc.chain] as const;

export const getNetwork = (mode: NetworkMode): NetworkDefinition => NETWORKS[mode];

export const getNetworkByChainId = (chainId: number): NetworkDefinition | undefined =>
...
export const getApiPrefix = (mode: NetworkMode): string => NETWORKS[mode].apiPrefix;
