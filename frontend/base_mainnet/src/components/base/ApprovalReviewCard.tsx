  ...
  return (
    <div className="border-[3px] border-[#1A1A1A] bg-[#FFE4A3] p-3 text-[#1A1A1A] shadow-[3px_3px_0_#1A1A1A]">
      ...
      <p className="mt-2 text-[10px] font-bold leading-relaxed">
        Unlimited approval kullanılmaz. Cüzdan {network === 'base' ? 'atomic' : 'batch'}
        {' '}çağrıyı desteklemiyorsa approval ana işlemden önce ayrı bir işlem
        olabilir; ana işlem tamamlanmazsa kalan allowance&apos;ı cüzdanınızdan
        gözden geçirip revoke edin.
      </p>
    </div>
  );
}
